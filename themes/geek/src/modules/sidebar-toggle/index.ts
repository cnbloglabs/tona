import type { ToolbarButtonOptions, ToolbarItem } from 'tona-plugins'
import './index.scss'
...
let sidebarToggleObserver: MutationObserver | null = null
 ...
 */
export function createSidebarToggleToolbarItem(
  options: Pick<ToolbarButtonOptions, 'enable' | 'page' | 'iconType' | 'tooltip'> = {},
): ToolbarItem {
  const {
    enable = true,
    page = 'all',
